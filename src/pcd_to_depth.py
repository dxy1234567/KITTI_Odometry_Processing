...
def pcd_to_depth(height, width, dir_pcd, path_calib, dir_output):
    pcd_lists = read_pcd_list(dir_pcd)

    T_CL = read_calib_T(path_calib)
...
def pcd_to_com_depth(height, width, dir_pcd, path_odom, path_calib, dir_output):
